...
//Write a derived query to list all cinemas in a specific country
    List<Cinema> findAllByByLocationCountry( String country);

//Write a derived query to list all cinemas with a specific name or sponsored name
    List<Cinema>findAllByByNameOrSponsoredName( String name, String sponsoredname);
...
//Write a JPQL query to read the cinema name with a specific id
    ...
    String fetchByIdJBQL (Integer id);
...
//Write a native query to read all cinemas by location country
    ...
    List<Cinema> retrievealllByLocation(String locationcountry);
